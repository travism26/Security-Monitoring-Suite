...
const mockAlerts = [
  { id: 1, message: 'High CPU usage detected', timestamp: '2023-06-17T14:30:00Z' },
  { id: 2, message: 'Unusual network activity', timestamp: '2023-06-17T15:45:00Z' },
  { id: 3, message: 'Failed login attempts', timestamp: '2023-06-17T16:20:00Z' },
];
...
export const apiService = {
  ...
  signup: async (email: string, password: string) => {
    const newUser = { id: String(mockUsers.length + 1), name: 'New User', email };
